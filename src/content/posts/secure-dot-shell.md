...
<p><a href="/posts/writeups/picoctf/remote.py" download>file</a></p>
...
CBC (Cipher Block Chaining) splits the padded plaintext into 16-byte blocks (P1, P2, P3...) and encrypts each block at a time. The ciphertext of the previous block is XOR'ed with the next plaintext before encryption with the key. So, given plaintext chunks P1, P2, P3..., ciphertext chunks C1, C2, C3...
