...
<figure>
  <img alt="A billboard advertising Vercel's AI SDK styled as an npm package page" src="/assets/posts/fomo-billboards/image.png" loading="lazy" decoding="async" />
  <figcaption>This is an ad for Vercel's <a href="https://www.npmjs.com/package/ai">AI SDK</a> on the npm package manager.</figcaption>
</figure>

<figure>
  <img alt="A billboard of tokenizer IDs that decode to a listenlabs.ai puzzle URL" src="/assets/posts/fomo-billboards/image-1.png" loading="lazy" decoding="async" />
  <figcaption>Each number references an ID in OpenAI's LLM tokenizer, spelling out <a href="https://listenlabs.ai/puzzle">https://listenlabs.ai/puzzle</a>. This was used as a promotion to find AI engineers to hire.</figcaption>
</figure>
...
> for further reference, observe [https://en.wikipedia.org/wiki/In-group_and_out-group](https://en.wikipedia.org/wiki/In-group_and_out-group)
