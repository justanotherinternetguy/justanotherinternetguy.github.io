...
![VSCodium folder search showing the isVirtualMachine function in the extension's obfuscated source](/assets/posts/breaking-cb-lockdown/image.png)
...
to start the VM results in

![webglreport showing the unmasked WebGL renderer reported as Mesa, virgl under QEMU](/assets/posts/breaking-cb-lockdown/image-1.png)

"Mesa, virgl" being reported.
...
![webglreport output after switching QEMU to the virtio-vga device](/assets/posts/breaking-cb-lockdown/image-2.png)
